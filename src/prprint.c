...
int out_pair(listnode, substptr)
node_ptr_t listnode;
subst_ptr_t substptr;
{
	int len;
...
int out1_pair(nodeptr, substptr)
node_ptr_t nodeptr;
subst_ptr_t substptr;
{
	node_ptr_t tailptr;
 ...
 ******************************************************************************/
int tty_out_node(nodeptr, substptr)
node_ptr_t nodeptr;
subst_ptr_t substptr;
{
FILE *save_ofp;
...
virtual way, as expected in a structure sharing implementation.
 ...
 list.
 ******************************************************************************/
int maplist(listnode, substptr , fn)
node_ptr_t listnode;
