...
void *objptr;
{
	if(((objptr >= (void*)HighHeap_ptr)||(objptr < (void*)Heap_mem))
	    && ((objptr >= (void*)HighDyn_ptr)||(objptr < (void*)Dyn_mem))
	    && ((objptr >= (void*)HighTemp_ptr)||(objptr < (void*)Temp_mem))
	    && ((objptr >= (void*)HighStr_ptr)||(objptr < (void*)Str_mem))
	    )
	{
		errmsg(WILDPOINTER);
