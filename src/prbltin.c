...
int bind_string(narg, stringptr)
...
#ifdef HAVE_RANDOM
#define SPR_RAND	random
#else
#define SPR_RAND	rand
#endif
...
randnum = (integer)SPR_RAND() % (limit + 1);
