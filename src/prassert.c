 ...
 *********************************************************************/
int do_assertz(status, nodeptr, substptr)
node_ptr_t nodeptr;
subst_ptr_t substptr;
{
 ...
 *********************************************************************/
int do_asserta(status, nodeptr, substptr)
node_ptr_t nodeptr;
subst_ptr_t substptr;
{
	clause_ptr_t clauseptr;
...
/******************************************************************************
 ...
 n begins at 1.
 ******************************************************************************/
int do_assertn(status, nodeptr, substptr, n)
node_ptr_t nodeptr;
subst_ptr_t substptr;
integer n;
{
...
/******************************************************************************
			remove_clause()
 ******************************************************************************/
int remove_clause(atomptr, clauseptr)
 ...
 ******************************************************************************/
int add_as_nth(clauseptr, pred, n)
clause_ptr_t clauseptr;
atom_ptr_t pred;
integer n;
{
